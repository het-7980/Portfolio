...
export const icons: Record<string, string> = {
  ...
  browser: wrap(
    '<rect x="2.5" y="4.5" width="19" height="15" rx="2.5"/><path d="M2.5 9h19M6 6.8h.01M8.6 6.8h.01"/>',
  ),
  database: wrap(
    '<ellipse cx="12" cy="6" rx="7.5" ry="3.2"/><path d="M4.5 6v12c0 1.8 3.4 3.2 7.5 3.2s7.5-1.4 7.5-3.2V6M4.5 12c0 1.8 3.4 3.2 7.5 3.2s7.5-1.4 7.5-3.2"/>',
  ),
  code: wrap('<path d="m8.5 8-4.5 4 4.5 4M15.5 8l4.5 4-4.5 4M13.5 5l-3 14"/>'),
  branch: wrap(
    '<circle cx="7" cy="5.5" r="2.2"/><circle cx="7" cy="18.5" r="2.2"/><circle cx="17" cy="9" r="2.2"/><path d="M7 7.7v8.6M17 11.2c0 3.2-3.4 3-6.5 3.6"/>',
  ),
  sun: wrap(
  ...
  cap: wrap(
    '<path d="m12 4 9.5 4.6L12 13.2 2.5 8.6 12 4Z"/><path d="M6.5 10.8v4.6c0 1.6 2.5 2.9 5.5 2.9s5.5-1.3 5.5-2.9v-4.6M20.4 9.2v5.4"/>',
  ),
